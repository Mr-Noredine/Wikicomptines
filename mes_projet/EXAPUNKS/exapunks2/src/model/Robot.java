...
public class Robot {
    ...
    public void DROP() {
        ...
        if (!grille.estZoneAccessible(this.positionX, this.positionY)|| grille.estPorteNumerotee(this.positionX, this.positionY)) {
    ...
    public int getPremierNombre() {
        String premierNombreStr = fichierEnPossession.retirerContenu(); // Utilise dequeue pour obtenir la première ligne
    ...
    public void add(String caseMemoireSource, String caseMemoireDestination) {
        ...
        int premierNombre = getPremierNombre();
...
public void sub(String caseMemoireSource, String caseMemoireDestination) {
    if (this.fichierEnPossession != null) {
        ...
        int chiffreFichier =getPremierNombre();
        int valeurMemoire = (Integer) casesMemoire[indexSource];
